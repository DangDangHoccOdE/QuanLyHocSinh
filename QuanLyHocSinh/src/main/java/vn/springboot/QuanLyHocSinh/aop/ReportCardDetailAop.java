...
public class ReportCardDetailAop {
    ...
    @Before("(execution( * vn.springboot.QuanLyHocSinh.rest.ReportCardDetailController.createReportCard(..))" +
            "|| execution( * vn.springboot.QuanLyHocSinh.rest.ReportCardDetailController.saveReportCard(..))) && args(..,classId)")
    ...
    @Before(value = "execution( * vn.springboot.QuanLyHocSinh.rest.ReportCardDetailController.showReportCardDetail(..)) && args(..,subjectId,studentId,semesterYear)", argNames = "subjectId,studentId,semesterYear")
